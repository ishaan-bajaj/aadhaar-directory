...
import { idlFactory } from './Aadhaar_directory.did.js';
export { idlFactory } from './Aadhaar_directory.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.AADHAAR_DIRECTORY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Aadhaar_directory.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Aadhaar_directory canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Aadhaar_directory.did.js")._SERVICE>}
 */
export const Aadhaar_directory = createActor(canisterId);
